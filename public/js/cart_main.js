...
function ajaxUpdateNum(index,num){
    ...
    $.ajax({
        type:"post",
        url:"CartClServlet?dowhat=updateBoughtNumInCart",
        data:{
            index:index,
            boughtNum:num
        }
...
function ajaxUpdateACheck(index,checked){
    ...
    $.ajax({
        type:"post",
        url:"CartClServlet?dowhat=checkABookInCart",
        data:{
            index:index,
            checked:checked
        }
...
function ajaxUpdateAllChecks(checked){
    ...
    $.ajax({
        type:"post",
        url:"CartClServlet?dowhat=checkAllBooksInCart",
        data:{
            checked:checked
        }
    });
...
function ajaxDeleteABookInCart(index){
    ...
    $.ajax({
        type:"post",
        url:"CartClServlet?dowhat=delABookInCart",
        data:{
            index:index
        }
    });
...
function ajaxDeleteAllBooksInCart(){
    ...
    $.ajax({
        type:"post",
        url:"CartClServlet?dowhat=delAllBooksInCart"
    });
}
